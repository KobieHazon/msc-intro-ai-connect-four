...
if __name__ == '__main__':
    ...
    # assign directory
    directory = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), 'tests', 'fixtures')
    ...
    for filename in os.listdir(directory):
        ...
        if os.path.isfile(f):
            ...
            if result == studentResult:
                print("Test file:   ***"+os.path.basename(f) + "***   Good! :)")
            else:
                print("Test file:   ***"+os.path.basename(f) + "***   Something went wromg... ")
